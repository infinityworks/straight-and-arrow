...
describe("convert Ms and Xs module", function() {
   ...
   it("Keeps score at 10 if spider is 0", function() {
      ...
      result = converter.convertMX(fakeRowWithNoSpiderAndHighScore)

      expect(result).toEqual({ arrow: 3, score: 10, spider: 0})
   });
});
...
[ { endCounter: 1, endIndex: [  { arrow: 1, score: 8, spider: 0 },
  ...
  { endCounter: 2, endIndex: [  { arrow: 7, score: 6, spider: 0 },
  ...
  { endCounter: 3, endIndex: [  { arrow: 13, score: 1, spider: 0 },
  ...
  { endCounter: 4, endIndex: [  { arrow: 19, score: 7, spider: 0 },
  ...
  { endCounter: 5, endIndex: [  { arrow: 25, score: 'X', spider: 1},
